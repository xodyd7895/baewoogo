          ...
          자바
            ...
            <span class="checkbox_mark"></span>
							...
							<div class="writer_btn">
									<button input type="button"class="btn_enter"  id="next" disabled style="float:right" onclick="location.href='gosuLogin3'">
									다음
									</button>
									
									<button input type="button" class="btn_enter" style="float:right" onclick="location.href='gosuLogin_study'"> 
									이전
									</button>
								</div>
