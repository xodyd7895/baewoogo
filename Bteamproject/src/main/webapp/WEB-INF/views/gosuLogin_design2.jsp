...
<head>
	...
	<title>GosuLogin_design2</title>
<!-- 	<link href="//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
<!--  -->	<link rel="styleshee" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
				...
				<div class="card-wrapper">
					...
					<div class="card fat">
						<div class="card-body">
							...
							<h4 class="card-title">어떤 서비스를 제공할 수 있나요?</h4>
          ...
          의류
            ...
            <span class="checkbox_mark"></span>
							...
							<div class="writer_btn">
									...
									<button input type="button" class="btn_enter" style="float:right" onclick="location.href='gosuLogin_design'">
									이전
									</button>
								</div>
